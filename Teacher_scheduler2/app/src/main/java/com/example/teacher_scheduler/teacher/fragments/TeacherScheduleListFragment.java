...
public class TeacherScheduleListFragment extends Fragment {
     ...
     */
    public static TeacherScheduleListFragment newInstance() {
        TeacherScheduleListFragment fragment = new TeacherScheduleListFragment();
        Bundle args = new Bundle();
        // args.put... nếu muốn truyền dữ liệu
    ...
    // Class dữ liệu ScheduleItem
    public static class ScheduleItem {
        private String courseName, date, time, room, className;

        public ScheduleItem(String courseName, String date, String time, String room, String className) {
